  ...
  return (
    <div className='hidden md:flex justify-between items-center w-full px-5 bg-black py-3 relative'>
      <div className='flex items-center flex-1 min-w-0'>
        <Link to="/">
          <img src={spotifyLogo} alt="Spotify Logo" className="h-9" />
        </Link>
      </div>
      <div className='flex items-center gap-6 flex-[2] justify-center max-w-md w-full min-w-0'>
        ...
        <div
          className={`
            flex items-center text-white rounded-full px-4 py-1 w-full
            bg-[#1e1e1e] transition-all duration-300
            ${isFocused ? "ring ring-gray-500" : ""}
            hover:bg-[#2a2a2a] hover:border hover:border-gray-600
          `}
        >
        ...
        {!user ? (
          <>
            ...
            <Link to='/register/signup'>
              <div className='text-[#b3b3b3] hover:text-white hover:scale-105 transition-all duration-300 font-bold'>Sign up</div>
            </Link>
            <Link to='/register/login'>
              <div className='bg-white text-black hover:bg-[#f0f0f0] px-[30px] py-3 rounded-3xl font-bold hover:scale-105 transition-all duration-300'>Log in</div>
            </Link>
          </>
        ) : (
          <>
              ...
              {dropdownOpen && (
                <div className="absolute right-0 top-full mt-2 bg-[#121212] rounded-md shadow-lg w-40 z-50">
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-2 text-white hover:bg-green-600 transition"
                  >
                    Logout
                  </button>
                </div>
